...
public static class PhantomCamera3DExtensions
{
    ...
    public static void SetThirdPersonRotationDegrees(
        this PhantomCamera3D pCam3D,
        Vector3 rotation
    ...
    public static void SetThirdPersonQuaternion(
        this PhantomCamera3D pCam3D,
...
public class PhantomCamera3D : PhantomCamera
{
    ...
    public delegate void Camera3DResourcePropertyChangedEventHandler(
        StringName property,
        Variant value
    );
    ...
    {
        get =>
            Node3D.Call(PhantomCamera.MethodName.GetFollowTargets).AsGodotArray<Node3D>().ToArray();
        set => Node3D.Call(PhantomCamera.MethodName.SetFollowTargets, new Array<Node3D>(value));
    }

    public void AppendFollowTarget(Node3D target) =>
        Node3D.Call(PhantomCamera.MethodName.AppendFollowTargets, target);

    public void AppendFollowTargetArray(Node3D[] targets) =>
        Node3D.Call(PhantomCamera.MethodName.AppendFollowTargetsArray, targets);

    public void EraseFollowTarget(Node3D target) =>
        Node3D.Call(PhantomCamera.MethodName.EraseFollowTargets, target);

    public FollowMode3D FollowMode =>
        (FollowMode3D)(int)Node.Call(PhantomCamera.MethodName.GetFollowMode);
    ...
    public void EmitNoise(Transform3D transform) =>
        Node3D.Call(PhantomCamera.MethodName.EmitNoise, transform);

    public PhantomCamera3D(GodotObject phantomCamera3DNode)
        : base(phantomCamera3DNode)
    {
        ...
        var callableCamera3DResourceChanged = Callable.From(() =>
            Camera3DResourceChanged?.Invoke()
        );
        var callableCamera3DResourcePropertyChanged = Callable.From(
            (StringName property, Variant value) =>
                Camera3DResourcePropertyChanged?.Invoke(property, value)
        );
        var callableTweenInterrupted = Callable.From<Node3D>(pCam =>
            TweenInterrupted?.Invoke(pCam)
        );
        var callableNoiseEmitted = Callable.From(
            (Transform3D output) => NoiseEmitted?.Invoke(output)
        );
        ...
        Node3D.Connect(
            SignalName.Camera3DResourcePropertyChanged,
            callableCamera3DResourcePropertyChanged
        );
    ...
    public static new class MethodName
    {
        ...
        public static readonly StringName GetThirdPersonRotationDegrees = new(
            "get_third_person_rotation_degrees"
        );
        public static readonly StringName SetThirdPersonRotationDegrees = new(
            "set_third_person_rotation_degrees"
        );

        public static readonly StringName GetThirdPersonQuaternion = new(
            "get_third_person_quaternion"
        );
        public static readonly StringName SetThirdPersonQuaternion = new(
            "set_third_person_quaternion"
        );

        public static readonly StringName GetVerticalRotationOffset = new(
            "get_vertical_rotation_offset"
        );
        public static readonly StringName SetVerticalRotationOffset = new(
            "set_vertical_rotation_offset"
        );

        public static readonly StringName GetHorizontalRotationOffset = new(
            "get_horizontal_rotation_offset"
        );
        public static readonly StringName SetHorizontalRotationOffset = new(
            "set_horizontal_rotation_offset"
        );
        ...
        public static readonly StringName GetAutoFollowDistanceMin = new(
            "get_auto_follow_distance_min"
        );
        public static readonly StringName SetAutoFollowDistanceMin = new(
            "set_auto_follow_distance_min"
        );

        public static readonly StringName GetAutoFollowDistanceMax = new(
            "get_auto_follow_distance_max"
        );
        public static readonly StringName SetAutoFollowDistanceMax = new(
            "set_auto_follow_distance_max"
        );

        public static readonly StringName GetAutoFollowDistanceDivisor = new(
            "get_auto_follow_distance_divisor"
        );
        public static readonly StringName SetAutoFollowDistanceDivisor = new(
            "set_auto_follow_distance_divisor"
        );
    ...
    public static new class SignalName
    {
        ...
        public static readonly StringName Camera3DResourceChanged = new(
            "camera_3d_resource_changed"
        );
        public static readonly StringName Camera3DResourcePropertyChanged = new(
            "camera_3d_resource_property_changed"
        );
    }
}
