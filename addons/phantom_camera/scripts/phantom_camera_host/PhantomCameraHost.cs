...
public class PhantomCameraHost()
{
    ...
    public PhantomCameraHost(GodotObject node)
        : this()
    {
        Node = node as Node;

        var callablePCamBecameActive = Callable.From<Node>(pCam => PCamBecameActive?.Invoke(pCam));
        var callablePCamBecameInactive = Callable.From<Node>(pCam =>
            PCamBecameInactive?.Invoke(pCam)
        );
    ...
    public void SetHostLayersValue(int layer, bool value) =>
    ...
    public bool TriggerPhantomCameraTween =>
        (bool)Node.Call(MethodName.GetTriggerPhantomCameraTween);
    ...
    public static class MethodName
    {
        ...
        public static readonly StringName GetTriggerPhantomCameraTween = new(
            "get_trigger_pcam_tween"
        );
