...
public class PhantomCameraNoise2D(Resource resource)
{
    ...
    public static PhantomCameraNoise2D New()
    {
        ...
        resource.SetScript(
            GD.Load<GDScript>(
                "res://addons/phantom_camera/scripts/resources/phantom_camera_noise_2d.gd"
            )
        );
#endif
    ...
    public static class MethodName
    {
        ...
        public static readonly StringName GetRotationalMultiplier = new(
            "get_rotational_multiplier"
        );
        public static readonly StringName SetRotationalMultiplier = new(
            "set_rotational_multiplier"
        );
