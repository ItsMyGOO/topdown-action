...
public class PhantomCameraNoise3D(Resource resource)
{
    ...
    public static PhantomCameraNoise3D New()
    {
        ...
        resource.SetScript(
            GD.Load<GDScript>(
                "res://addons/phantom_camera/scripts/resources/phantom_camera_noise_3d.gd"
            )
        );
#endif
    ...
    public static class MethodName
    {
        ...
        public static readonly StringName GetRotationalMultiplierX = new(
            "get_rotational_multiplier_x"
        );
        public static readonly StringName SetRotationalMultiplierX = new(
            "set_rotational_multiplier_x"
        );

        public static readonly StringName GetRotationalMultiplierY = new(
            "get_rotational_multiplier_y"
        );
        public static readonly StringName SetRotationalMultiplierY = new(
            "set_rotational_multiplier_y"
        );

        public static readonly StringName GetRotationalMultiplierZ = new(
            "get_rotational_multiplier_z"
        );
        public static readonly StringName SetRotationalMultiplierZ = new(
            "set_rotational_multiplier_z"
        );

        public static readonly StringName GetPositionalMultiplierX = new(
            "get_positional_multiplier_x"
        );
        public static readonly StringName SetPositionalMultiplierX = new(
            "set_positional_multiplier_x"
        );

        public static readonly StringName GetPositionalMultiplierY = new(
            "get_positional_multiplier_y"
        );
        public static readonly StringName SetPositionalMultiplierY = new(
            "set_positional_multiplier_y"
        );

        public static readonly StringName GetPositionalMultiplierZ = new(
            "get_positional_multiplier_z"
        );
        public static readonly StringName SetPositionalMultiplierZ = new(
            "set_positional_multiplier_z"
        );
    }
}
